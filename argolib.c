...
static void create_pools(int num_xstreams);
static void create_scheds(int num_xstreams);
...
void argolib_init(int argc, char **argv) {
    ...
    /* Create pools. */
    create_pools(num_xstreams);

    /* Create schedulers. */
    create_scheds(num_xstreams);
...
static void create_scheds(int num) {
...
static void create_pools(int num) {
    /* Pool definition */
